...
int main() {
	...
	variable_t chr_ret1_data = {.float64_t = 0.0};
	elem_t *chr_ret1 = create_var_item("chr1", VAR_FLOAT64, chr_ret1_data, false, false);
	...
	add_instruction(IC_READ_FLOAT, chr, NULL, NULL);
