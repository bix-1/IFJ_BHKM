...
int main() {
	...
	variable_t chr_par1_data = {.int_t = 65};
	elem_t *chr_par1 = create_var_item("chr1par1", VAR_INT, chr_par1_data, true, false);
	...
	elem_t *chr = create_function("chr", params->symbol.sym_var_list, returns->symbol.sym_var_list);
	...
	add_instruction(IC_GETCHAR_STR, chr, NULL, NULL);
