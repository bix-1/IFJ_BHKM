...
int main() {
	...
	variable_t chr_ret1_data = {.bool_t = false};
	elem_t *chr_ret1 = create_var_item("chr1", VAR_BOOL, chr_ret1_data, false, false);
	...
	add_instruction(IC_READ_BOOL, chr, NULL, NULL);
